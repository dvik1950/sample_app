...
EDIT: I've stopped following the book directly, instead I'm using seperate chapters and instructions to implement the features explained in the book to different projects
